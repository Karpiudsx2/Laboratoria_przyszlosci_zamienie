--
-- File generated with SQLiteStudio v3.3.3 on niedz. wrz 25 10:30:13 2022
--
...
Natywna obs³uga kilku rodzajów plików wejœciowych: STL, SolidWorks, Solid Edge, Catia, Unigraphics
...
Serwis i wsparcie techniczne w jêzyku polskim
...
Akcesoria do drukarki
 ...
 • Stó³ roboczy, w tym zestaw narzêdzi: szpachelka, c¹¿ki do usuwania podpór oraz inne akcesoria
 ...
 • Szkolenie startowe dla nauczycieli prowadzone w formie zdalnej lub stacjonarnej
   ...
   • Mo¿liwoœæ pod³¹czenia poprzez urz¹dzenia mobilne
...
Minimalna wysokoœæ warstwy: 0,02 mm
...
• Mo¿liwoœæ pod³¹czenia poprzez urz¹dzenia mobilne
 ...
 • Instrukcja obs³ugi w jêzyku polskim');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (3, 'S3', '6', 'Filament biodegradowalny PLA', 'Dedykowany filament do drukarki 3d w ró¿nych kolorach
...
Rozmiar skanowanych przedmiotów do 700 x 700 x 700mm
...
UdŸwig stolika: przynajmniej 4kg
...
Obs³uga plików CAD: w tym OBJ,STL,ASC,PLY');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (5, 'S5', '1', 'Zestawy do programowania mikrokontrolerów i nauki elektroniki', '');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
...
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (29, 'S29', '8', 'Zestaw do monta¿u podstawowych obwodów elektrycznych', '');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (30, 'S30', '8', 'Komplet do monta¿u obwodów elektrycznych z silniczkiem', '');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (31, 'S31', '7', 'G³oœniki bezprzewodowe', '');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
...
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (37, 'S37', '2', 'Stó³ warsztatowy z wyposa¿eniem', '');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
...
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (42, 'S42', '5', 'Blender rêczny', '');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
VALUES (43, 'S43', '7', 'Przenoœny zestaw nag³oœnieniowy', '');
INSERT INTO Device (id, scholl_id, kategoria_id, name, description)
...
INSERT INTO File (id, typ, filename, raport_id)
VALUES (1, 'image', 'a1482e12-6b1f-4ddb-9151-c8f9d5155782.jpg', 1);
INSERT INTO File (id, typ, filename, raport_id)
VALUES (2, 'image', 'b182f646-1a64-416c-a570-d8a667b4e202.jpg', 1);
INSERT INTO File (id, typ, filename, raport_id)
VALUES (3, 'image', 'fdd5f23a-a2cf-4748-b20e-c8a1c3205178.jpg', 2);
INSERT INTO File (id, typ, filename, raport_id)
VALUES (4, 'image', '62c8028a-6642-4424-9df6-0f63939fe2f0.jpg', 4);
...
INSERT INTO Raport (id, user_id, deviceusage_id, subject, input_date, class_date, reference, description, uwagi)
VALUES (1, 1, 1, 3, '2022-09-19 20:10:05', '2022-09-07 00:00:00.000000', 'Figury 3d', 'sadasd', NULL);
INSERT INTO Raport (id, user_id, deviceusage_id, subject, input_date, class_date, reference, description, uwagi)
VALUES (2, 1, 2, 16, '2022-09-19 21:33:56', '2022-09-17 00:00:00.000000', 'dsadds',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
        NULL);
INSERT INTO Raport (id, user_id, deviceusage_id, subject, input_date, class_date, reference, description, uwagi)
VALUES (3, 1, 3, 12, '2022-09-19 22:01:36', '2022-09-07 00:00:00.000000', 'sadasdasdasdasd',
        'asdasdasdsadasdasdasds {% set var = namespace(x=0) %} {% set var = namespace(x=0) %} {% set var = namespace(x=0) %} {% set var = namespace(x=0) %} {% set var = namespace(x=0) %} {% set var = namespace(x=0) %}',
        NULL);
INSERT INTO Raport (id, user_id, deviceusage_id, subject, input_date, class_date, reference, description, uwagi)
VALUES (4, 1, 4, 19, '2022-09-19 22:02:31', '2022-09-10 00:00:00.000000', 'asdasdasdasdasd', 'dasdasdasd', NULL);
INSERT INTO Raport (id, user_id, deviceusage_id, subject, input_date, class_date, reference, description, uwagi)
VALUES (5, 1, 5, 16, '2022-09-19 22:03:10', '2022-09-04 00:00:00.000000', 'dsfsdfsf', 'fdsfdsfdsf', NULL);
...
VALUES (2, 'chemia');
INSERT INTO TaughtSubject (id, subject)
VALUES (3, 'edukacja dla bezpieczeñstwa');
INSERT INTO TaughtSubject (id, subject)
...
INSERT INTO TaughtSubject (id, subject)
VALUES (9, 'jêzyk angielski');
INSERT INTO TaughtSubject (id, subject)
VALUES (10, 'drugi jêzyk nowo¿ytny');
INSERT INTO TaughtSubject (id, subject)
VALUES (11, 'jêzyk polski');
INSERT INTO TaughtSubject (id, subject)
...
VALUES (17, 'technika');
INSERT INTO TaughtSubject (id, subject)
VALUES (18, 'wiedza o spo³eczñstwie');
INSERT INTO TaughtSubject (id, subject)
...
INSERT INTO TaughtSubject (id, subject)
VALUES (22, 'zajêcia z wychowawc¹');
INSERT INTO TaughtSubject (id, subject)
VALUES (23, 'zajêcia wyrównawcze');
INSERT INTO TaughtSubject (id, subject)
VALUES (24, 'ko³a zainteresowañ');
INSERT INTO TaughtSubject (id, subject)
VALUES (25, 'terapia pedagogiczna');
INSERT INTO TaughtSubject (id, subject)
VALUES (26, 'zajêcia korekcyjno-kompensacyjna');
INSERT INTO TaughtSubject (id, subject)
VALUES (27, 'inne');
...
INSERT INTO User (id, email, subject1_id, subject2_id, subject3_id, password, firstname, lastname, is_admin,
                  is_managment)
VALUES (1, 'karpiniakpiotr@gmail.com', 12, NULL, NULL,
        'pbkdf2:sha256:260000$Pn9QxBdY9ON52EXv$85d32d069747767aa50ea7419040a2b95a54b3d3bde486e34a1c6f8e32e4e2ef',
        'Wis³aw', 'Karpiniak', 1, 0);
INSERT INTO User (id, email, subject1_id, subject2_id, subject3_id, password, firstname, lastname, is_admin,
                  is_managment)
...
VALUES (3, 'zdzislaw.sienkiwicz@spsekocin.com.pl', 2, NULL, NULL,
        ...
        'Zdzis³aw', 'Sienkiewicz', NULL, NULL);
INSERT INTO User (id, email, subject1_id, subject2_id, subject3_id, password, firstname, lastname, is_admin,
                  is_managment)
